package com.freedom.freedomCore.config.sms;
...
public class JuHeService {
     ...
     * sms 短信注册模板
     */
    @Value("${sms.tplId.register}")
    private Integer register;

    /**
     * sms 一点通模板
     */
    @Value("${sms.tplId.aLittleBit}")
    private Integer aLittleBit;

    /**
     * sms 预约接送模板
     */
    @Value("${sms.tplId.bookingCar}")
    private Integer bookingCar;

    /**
     * sms 预约接送模板
     */
    @Value("${sms.tplId.smsCoachAppiontment}")
    private Integer smsCoachAppiontment;
     ...
     * @return JSONObject
     */
    public JSONObject getRequestForSend(String mobile, Integer tplId, Map<String, String> param) {
        ...
        try {
            ...
            String codeStr = getSendParams(tplId, param);
            ...
            object.accumulate("tpl_value", codeStr);
     ...
     * @throws Exception exception
     */
    public String getSendParams(int tplId, Map<String, String> param) throws Exception {
